...
<ul id="menu" class="roundedcorner">
...
<div id="bus17" class="data roundedcorner" style="display: none">
		...
		<h2>Arrival at Bus Stop: <?php echo $arrivalatBusStopForBus17Epoch; ?></h2>
...
<div id="bus153" class="data roundedcorner" style="display: none">
		...
		<h2>Arrival at Bus Stop: <?php echo $arrivalatBusStopForBus153Epoch; ?></h2>
...
<div id="bus91" class="data roundedcorner" style="display: none">
		...
		<h2>Arrival at Bus Stop: <?php echo $arrivalatBusStopForBus91Epoch; ?></h2>
...
<div id="tfl" class="data roundedcorner" style="display: none">
		...
		<h1>TFL</h1>
		<h2>BUS 17</h2>
		<h2>1st Prediction: <?php echo date("H:i:s", $predictions17[0][1]); ?> || <?php if ($prediction17_valid1==0) {echo INVALID;} else {echo VALID;}; ?></h2>
		<h2>2nd Prediction: <?php echo date("H:i:s", $predictions17[0][2]); ?> || <?php if ($prediction17_valid2==0) {echo INVALID;} else {echo VALID;}; ?></h2>
		<h2>3rd Prediction: <?php echo date("H:i:s", $predictions17[0][3]); ?> || <?php if ($prediction17_valid3==0) {echo INVALID;} else {echo VALID;}; ?></h2>
		<h2>4th Prediction: <?php echo date("H:i:s", $predictions17[0][4]); ?> || <?php if ($prediction17_valid4==0) {echo INVALID;} else {echo VALID;}; ?></h2>

		<h2>BUS 153</h2>
		<h2>1st Prediction: <?php echo date("H:i:s", $predictions153[0][1]); ?> || <?php if ($prediction153_valid1==0) {echo INVALID;} else {echo VALID;}; ?></h2>
		<h2>2nd Prediction: <?php echo date("H:i:s", $predictions153[0][2]); ?> || <?php if ($prediction153_valid2==0) {echo INVALID;} else {echo VALID;}; ?></h2>
		<h2>3rd Prediction: <?php echo date("H:i:s", $predictions153[0][3]); ?> || <?php if ($prediction153_valid3==0) {echo INVALID;} else {echo VALID;}; ?></h2>
		<h2>4th Prediction: <?php echo date("H:i:s", $predictions153[0][4]); ?> || <?php if ($prediction153_valid4==0) {echo INVALID;} else {echo VALID;}; ?></h2>

		<h2>BUS 91</h2>
		<h2>1st Prediction: <?php echo date("H:i:s", $predictions91[0][1]); ?> || <?php if ($prediction91_valid1==0) {echo INVALID;} else {echo VALID;}; ?></h2>
		<h2>2nd Prediction: <?php echo date("H:i:s", $predictions91[0][2]); ?> || <?php if ($prediction91_valid2==0) {echo INVALID;} else {echo VALID;}; ?></h2>
		<h2>3rd Prediction: <?php echo date("H:i:s", $predictions91[0][3]); ?> || <?php if ($prediction91_valid3==0) {echo INVALID;} else {echo VALID;}; ?></h2>
		<h2>4th Prediction: <?php echo date("H:i:s", $predictions91[0][4]); ?> || <?php if ($prediction91_valid4==0) {echo INVALID;} else {echo VALID;}; ?></h2>
